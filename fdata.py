...
if view =='Fighter One Sheet':
    ...
    if fighter_filter:
        ...
        with c1:
            ...
            st.area_chart(duckdb.sql(f"SELECT a.DATE, sum(a.sig_str_a::INT)-sum(b.sig_str_a::INT) as Strike_Diff from fighter_stats as a inner join opp_stats as b on a.DATE = b.DATE and a.BOUT=b.BOUT group by 1").df(),x='DATE')
