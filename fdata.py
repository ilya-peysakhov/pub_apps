...
def getData():
  ...
  fd_backfill = duckdb.read_csv("https://raw.githubusercontent.com/grecoscraper/main/ufcdata/details.csv").df()
  ...
  fr_backfill = duckdb.read_csv("https://raw.githubusercontent.com/grecoscraper/main/ufcdata/results.csv").df()
  ...
  fs_backfill = duckdb.read_csv("https://raw.githubusercontent.com/grecoscraper/main/ufcdata/stats.csv").df()
