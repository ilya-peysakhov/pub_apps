...
if view=='Welcome':
  ...
  c1.metric('Significant Strikes Differential',width=metric_width, value=sig_strike_diff,border=True,width='content')
  head_strike_diff = round(cleaned_fighter_stats1['head_str']/cleaned_opp_stats1['head_abs'],1)
  c1.metric('Head Strikes Differential',width=metric_width, value=head_strike_diff,border=True,width='content')
  power_diff = round(cleaned_fighter_stats1['kd']/cleaned_opp_stats1['kd_abs'],1)
  c1.metric('Power Differential (Knockdowns)',width=metric_width, value=power_diff,border=True,width='content')
  td_landed = int(cleaned_fighter_stats1['td_l'].iloc[0])
  c1.metric(label='Total Takedowns Landed',width=metric_width,value=td_landed,delta="{0:.0%}".format(round(float(cleaned_fighter_stats1['td_rate'].iloc[0]),2)),border=True,width='content')
  td_given = int(cleaned_opp_stats1['td_abs'].iloc[0])
  c1.metric(label='Total Takedowns Given Up',width=metric_width,value=td_given,delta="{0:.0%}".format(round(float(cleaned_opp_stats1['td_abs_rate'].iloc[0]),2)),border=True,width='content')
  td_diff = round(cleaned_fighter_stats1['td_l']/cleaned_opp_stats1['td_abs'],1)
  c1.metric('Takedown Differential',width=metric_width, value=td_diff,border=True,width='content')
  ...
  c1.metric('Head Movement',width=metric_width, value=head_movement1,border=True,width='content')
  ...
  c2.metric('Significant Strikes Differential',width=metric_width, value=sig_strike_diff2,border=True,width='content')
  head_strike_diff2 = round(cleaned_fighter_stats2['head_str']/cleaned_opp_stats2['head_abs'],1)
  c2.metric('Head Strikes Differential',width=metric_width, value=head_strike_diff2,border=True,width='content')
  power_diff2 = round(cleaned_fighter_stats2['kd']/cleaned_opp_stats2['kd_abs'],1)
  c2.metric('Power Differential (Knockdowns)',width=metric_width, value=power_diff2,border=True,width='content')
  td_landed_2 = int(cleaned_fighter_stats2['td_l'].iloc[0])
  c2.metric(label='Total Takedowns Landed',width=metric_width,value=td_landed_2,delta="{0:.0%}".format(round(float(cleaned_fighter_stats2['td_rate'].iloc[0]),2)),border=True,width='content')
  td_given_2 = int(cleaned_opp_stats2['td_abs'].iloc[0])
  c2.metric(label='Total Takedowns Given Up',width=metric_width,value=td_given_2,delta="{0:.0%}".format(round(float(cleaned_opp_stats2['td_abs_rate'].iloc[0]),2)),border=True,width='content')
  td_diff = round(cleaned_fighter_stats2['td_l']/cleaned_opp_stats2['td_abs'],1)
  c2.metric('Takedown Differential',width=metric_width, value=td_diff,border=True,width='content')
  ...
  c2.metric('Head Movement',width=metric_width, value=head_movement2,border=True,width='content')
