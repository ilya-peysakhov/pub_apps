...
if view=='Welcome':
  ...
  fighter1_filter = c1.selectbox('Pick Fighter 1', options=('Khabib Nurmagomedov',fighter_list))
  ...
  fighter2_filter = c2.selectbox('Pick Fighter 2', options=('Conor McGregor',fighter_list))
