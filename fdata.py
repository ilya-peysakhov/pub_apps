...
if view =='Fighter One Sheet':
    ...
    if fighter_filter:
        ...
        with c1:
            ...
            fig = px.area(str_a, x='DATE', y='Total_Strikes_At', template='seaborn')
        ...
        with c2:
            ...
            fig = px.area(td_dif, x='DATE', y='TD_At_Diff', template='seaborn')
            st.plotly_chart(fig,use_container_width=True)
